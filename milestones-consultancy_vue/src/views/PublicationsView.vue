        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-12 lg:mb-12 sm:mb-8">
          ...
          <div class="border-gray-200 border-2 rounded-md mt-2 px-10 py-16">
            ...
            <div class="flex">
                ...
                <div class="w-1/4">
                    <button class="inline-flex items-center rounded border border-burgundy bg-burgundy px-8 py-2 mb-3 text-white hover:bg-transparent hover:text-burgundy focus:outline-none focus:ring active:text-burgundy">
                        <a 
